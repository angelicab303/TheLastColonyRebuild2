...
public class ChaserEnemy extends Enemy {
    ...
    private static final int   NUM_ANIM_FRAMES = 6;
    /** How fast we change frames (one frame per 10 calls to update) */
    protected static final float ANIMATION_SPEED = 0.20f;

    private boolean chasingSurvivor;
    public boolean isChasingSurvivor(){return chasingSurvivor;}
    public void setChasingSurvivor(boolean value) {chasingSurvivor = value;}
