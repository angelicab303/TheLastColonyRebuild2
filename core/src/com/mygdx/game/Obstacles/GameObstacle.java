...
public interface GameObstacle {
    ...
    final short MASK_SMOG = CATEGORY_ENEMY | CATEGORY_SURVIVOR;
    final short MASK_PLAYER = CATEGORY_ENEMY | CATEGORY_SURVIVOR | CATEGORY_ENV | CATEGORY_TOXIC | CATEGORY_CARAVAN | CATEGORY_ITEM;
