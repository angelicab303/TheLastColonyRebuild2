...
public interface GameObstacle {
    ...
    final short CATEGORY_ITEM = 0x0200;
    final short MASK_SMOG = CATEGORY_ENEMY | CATEGORY_SURVIVOR | CATEGORY_PLAYER | CATEGORY_ITEM;
    final short MASK_PLAYER = CATEGORY_ENEMY | CATEGORY_SURVIVOR | CATEGORY_ENV | CATEGORY_TOXIC | CATEGORY_CARAVAN | CATEGORY_ITEM | CATEGORY_SMOG;
    final short MASK_ENEMY = CATEGORY_PLAYER | CATEGORY_ENEMY | CATEGORY_ENV |CATEGORY_SMOG | CATEGORY_PURIFIED | CATEGORY_CARAVAN ;
    final short MASK_SURVIVOR = CATEGORY_SMOG | CATEGORY_PLAYER| CATEGORY_ENEMY | CATEGORY_SURVIVOR | CATEGORY_ENV | CATEGORY_TOXIC; //| CATEGORY_CARAVAN;
    final short MASK_ENV = -1;

    final short MASK_ITEM = CATEGORY_PLAYER | CATEGORY_SMOG;

    final short MASK_PURIFIED = CATEGORY_ENV | CATEGORY_ENEMY | CATEGORY_VINE | CATEGORY_CARAVAN | CATEGORY_TOXIC;
    final short MASK_TOXIC = CATEGORY_ENV | CATEGORY_PLAYER | CATEGORY_SURVIVOR | CATEGORY_PURIFIED;
    final short MASK_VINE = CATEGORY_PURIFIED;
    final short MASK_CARAVAN = CATEGORY_PLAYER | CATEGORY_ENEMY | CATEGORY_PURIFIED | CATEGORY_TOXIC;
