...
public class LevelSelectMode2 implements Screen, InputProcessor, ControllerListener {
    ...
    class SmogWall {
         ...
         * @param y The y-position of the texture on screen
         */
        public SmogWall (Texture texture, float x, float y){
            this.texture = texture;
            startX = x;
            this.y = y;
            this.x = x;
         ...
         */
        private void draw(GameCanvas canvas){
            canvas.draw(texture, Color.WHITE, 0, texture.getHeight(), x, y, 0, scale, scale);
        }
    ...
    private Texture arrowRightDown;
    private Texture arrowLeft;
    private Texture arrowLeftDown;
...
//        this.scale.y = canvas.getHeight(); // /bounds.getHeight();
    ...
    public void gatherAssets(AssetDirectory directory) {
        ...
        arrowRight = directory.getEntry("levelSelect:arrowRight", Texture.class);
        arrowRightDown = directory.getEntry("levelSelect:arrowRightDown", Texture.class);
        arrowLeft = directory.getEntry("levelSelect:arrowLeft", Texture.class);
        arrowLeftDown = directory.getEntry("levelSelect:arrowLeftDown", Texture.class);
...
//        arrowTableR.setDebug(false);
        ...
        textButtonStyle.font = nullFont;
        textButtonStyle.up   = new TextureRegionDrawable(arrowRight);
