...
//	private TextureRegion statusFrgRight;
	...
	public LoadingMode(String file, GameCanvas canvas, int millis) {
		...
		loadingIcon = internal.getEntry( "loadingIcon", Texture.class );

		currentAnimator = new FilmStrip(loadingIcon,1,NUM_ANIM_FRAMES,NUM_ANIM_FRAMES);;
		aframe = 0.0f;
...
//				playButton = internal.getEntry("play",Texture.class);
	...
	private void draw() {
		...
		if (!isFinished){
			canvas.draw(currentAnimator, Color.WHITE, currentAnimator.getRegionWidth()/2, currentAnimator.getRegionHeight()/2, canvas.getWidth()/2, canvas.getHeight()/2, 0, 0.25f, 0.25f);
		}
