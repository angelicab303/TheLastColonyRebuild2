...
public class GameCanvas {
    ...
    /**Stuff for lights, may be moved?*/
    Lights lights;

    /**temporary Vector3s for unprojecting*/
    private Vector2 temp;
    private Vector3 temp1V3;
    private Vector3 temp2V3;
    ...
    public void createLights(World world){
        //sets up lights
...
//    }
     ...
     * @param sy
     */
    public void drawPhysics(CircleShape shape, Color color, float x, float y, float angle, float sx, float sy) {
        if (active != DrawPass.DEBUG) {
            Gdx.app.error("GameCanvas", "Cannot draw without active beginDebug()", new IllegalStateException());
            return;
        }
...
//        debugRender.end();
    ...
    public Vector2 unproject(Vector2 pos){
        temp1V3.set(pos.x, pos.y, 0);
        Vector3 unProPos = camera.unproject(temp1V3);
        return temp.set(temp1V3.x, temp1V3.y);
    }
}